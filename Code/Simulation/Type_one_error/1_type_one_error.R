...
save(p_ftop,file=paste0("./simulation/result1/ftop_",i1,".Rdata"))
save(p_mtop1,file=paste0("./simulation/result2/mtop1_",i1,".Rdata"))
save(p_mtop2,file=paste0("./simulation/result3/mtop2_",i1,".Rdata"))
