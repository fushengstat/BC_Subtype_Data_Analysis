...
setwd("/data/shengf2/simu_mtop/type1_hert/")
...
save(p_global_result_ftop,file=paste0("./result_four/result1/ftop_",i1,".Rdata"))
save(p_global_result_mtop1,file=paste0("./result_four/result2/mtop1_",i1,".Rdata"))
save(p_global_result_mtop2,file=paste0("./result_four/result3/mtop2_",i1,".Rdata"))
save(p_acat,file=paste0("./result_four/result/acat",i1,".Rdata"))
